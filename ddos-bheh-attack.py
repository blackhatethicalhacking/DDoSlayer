...
print("YouTube : https://www.youtube.com/channel/UC7-AsunT7zO-ny5-U8glqkw")
...
print("BHEH Is not responsible for misusing it and must have an NDA signed to perform such attacks")
print()
ip = input("IP Target : ")
